...
describe('CMS: Listing Page', {tags: ['@workflow', '@cms']}, () => {
    ...
    it('@base @cms: Create listing page', () => {
        ...
        cy.get(`${page.elements.categoryTreeItemInner}__content input`).type('Full width Listing Categorian');
        ...
        cy.get(`${page.elements.categoryTreeItemInner}:nth-child(1)`).contains('Full width Listing Categorian').click();
        ...
        cy.get('.sw-card.sw-category-layout-card .sw-category-layout-card__desc-headline').contains('CMS Full Listing Page');
