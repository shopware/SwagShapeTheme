...
PluginManager.register('ShapeFlyoutMenu', () => import('./plugin/main-menu/flyout-menu.plugin'), '[data-navigation-link]');
...
PluginManager.override('GallerySlider', () => import('./plugin/slider/gallery-slider.plugin'), '[data-gallery-slider]');
